  ...
  <body>
    <div class="main">
      <div class="form-c">
        <div class="boton-c">
          <div id="btn"></div>
          <button id="btnLogin" type="button" class="toggle-btn" onclick="login()"><p1>Log In</p1></button>
          <button id="btnRegister" type="button" class="toggle-btn" onclick="register()"><p1>Register</p1></button>
        </div>
        <form id="login" action="./login.php" method="post" class="input-g">
          ...
          <input type="password" class="input-field" name = "passwd" placeholder="Contraseña" required>
    ...
    /*
      ...
      */
      ...
      function register(){
        /*
        btnLogin.classList.add("white");
        btnRegister.classList.remove("white");
        */
        x.style.left = "-400px";
        y.style.left = "50px";
        z.style.left = "110px";
      ...
      function login(){
        /*
        btnLogin.classList.remove("white");
        btnRegister.classList.add("white");
        */
        x.style.left = "50px";
        y.style.left = "450px";
        z.style.left = "0px";
